...
def log_token_usage(result, file_name='token_usage_log.csv'):
...
if __name__ == "__main__":
    sdr = self_discover("A store sells a pack of 12 pencils for $3.60. How much does each pencil cost?")
    
    trajectory = f"""{sdr["selected_modules"]}

{sdr["adapted_modules"]}

{sdr["reasoning_structure"]}"""

    final_answer = sdr["answer"]

    print("Reasoning Trajectory: ", trajectory)
